...
namespace Concurrency.Implementation
{
    ...
    {
        int myID; // custom made public wouter
        ...
        public async Task<TransactionResult> StartTransaction(string startFunc, object funcInput)
        {
            ...
            if (res.exception == false)
            {
                res.resultObject = t1.Result.resultObject; // custom line wouter
            }
        ...
        {
            Console.WriteLine("ReceiveBatchSchedule");
        ...
        {
            Console.WriteLine("WaitForBatchCommit");
        ...
        {
            Console.WriteLine("AckBatchCommit");
